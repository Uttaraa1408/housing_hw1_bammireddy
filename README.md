...
For the remote repository, make a github repository named Housing_HW1_Bammireddy, then do;

```bash
git remote add origin git@github.com:Uttaraa1408/Housing_HW1_Bammireddy.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── Housing_HW1_Bammireddy	<- Your notebooks and scripts will live in the main project folder
